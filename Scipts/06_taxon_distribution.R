...
Heron_experiments_coordinates <- read.csv("Data/Metadata/Experiment_coordinates_RAW.csv", header = TRUE)
...
# 2. Heron geomorphic zones
geomorphic <- read_sf("Data/Env_data/Heron_2007_GeomorphicZoneMap/hr20070701qb_eco_geo_final_nm.shp")
...
# 4. Plot bar charts with cryptic taxa
long_df <- sites_sp %>%
...
# 5. Plot of dead and alive colonies following heat wave
summarized_data <- Exp_metadata %>%
